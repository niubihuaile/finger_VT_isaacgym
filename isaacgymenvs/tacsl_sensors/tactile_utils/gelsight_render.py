...
conf_finger = {
    'background_path': os.path.join(gelsight_path, "finger_data/bg.jpg"),
    'calib_path': os.path.join(gelsight_path, "finger_data/polycalib.npz"),
    'real_bg': os.path.join(gelsight_path, "finger_data/real_bg.npy"),
    'h': 240,
    'w': 320,
    'numBins': 120,
    'pixmm': 0.065,
